...
groups = {1: ['M35/2679', 'M35/0366', 'M35/0472', 'M35/0538'], 2: ['M35/0312', 'M35/0222'], 3: ['M34/0232', 'M34/0207'], 4: ['66204', '66213', '66210'], 5: ['66417'], 6: ['66214']}

change_points = {'M35/2679': 0.3, 'M35/0366': 0.05, 'M35/0472': 0.05, 'M35/0538': 0.05, 'M35/0312': 0.5, 'M35/0222': 0.1, 'M34/0232': 0.1, 'M34/0207': 0.3, '66204': 0.1, '66213': 0.1, '66417': 0.1, '66214': 0.1, '66210': 0.1}

y_axis_labels = {1: 'Depth below ground (m)', 2: 'Depth below ground (m)', 3: 'Depth below ground (m)', 4: 'Flow (m3/s)', 5: 'Flow (m3/s)', 6: 'Flow (m3/s)'}
    ...
    for ref in refs:
        ...
        if not data.empty:
            ...
            if g in [1, 2, 3]:
                ...
                data1 = data.resample('A-JUN').mean()
...
for g in groups:
    ...
    plot1.savefig(os.path.join(base_dir, 'plots', 'group_{g}_yearly_trend.png'.format(g=g)))
